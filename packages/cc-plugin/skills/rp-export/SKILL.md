...
1. Clarify first: if export purpose, scope, preset, or budget is ambiguous, ask with AskUserQuestion before spawning the builder.
2. Spawn the `context-builder` subagent with:
